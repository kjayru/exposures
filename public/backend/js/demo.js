...
$(".btn-btngal").on('click',function (e) {
    e.preventDefault();
    $("#galeria").html("");
    CKFinder.popup({
        chooseFiles: true,
        onInit: function (finder) {
            ...
            finder.on('files:choose', function (evt) {
               ...
               // document.getElementById('gallery').value = pathfile;
                ...
                $(".galeria").append(`<picture class="galeria__picture"><a href="#" data-key="${iden+1}" class="galeria__btnactive btn-sm btn-danger">X</a><img src="${hostedUrl}/${pathfile}" class="img-fluid galeria__imagen thumbnail"></picture>`);
...
$(document).on("click",".galeria__btn",function(e){
    e.preventDefault();
    let idem = $(this).data('key');
    let cadena = "#idgal"+idem;
