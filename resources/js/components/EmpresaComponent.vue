<template>
    <section class="container-fluid paginas">
        <div class="row justify-content-center" >
           <div class="col-md-8">
                <h3 class="pTitulo">Nuestra Historia</h3>
                <p>Exposure nacio bajo el nombre de MR Climbing en Agosto del 2007, su primer y unica marca
            ...
            <div class="col-md-8 bloque">
                <p>"Da igual nacer en medio de la llanura, donde los Alpes aparecen como un perfil lejano,
            ...
            <div class="col-md-8 bfinfo"  style="background:url('/images/empresa2.jpg') no-repeat 0px 0px; background-size:cover;">
                <div class="blqfoot">
                   <div class="row">
                       <div class="col-md-10">
                            <p class="first text-left">Siempre firmes con lo que realizamos.</p>
                            <p class="secoond text-left">En las montañas el musculo mas importante es la mente.</p>
                            <p class="tercero text-right">Wolfgang Gullich</p>
                       </div>
                       <div class="col-md-2 text-right">
                           <img src="/images/bgInfo.jpg"  class="img-fluid">
                       </div>
                   </div>
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <figure>
                            <img src="http://exposure.mx/images/prox1.jpg" class="img-fluid">
                        </figure>
                        <h4>ASPECT</h4>
                    ...
                    <div class="col-md-3">
                        <figure>
                            <img src="http://exposure.mx/images/prox2.jpg" class="img-fluid">
                        </figure>
                        <h4>ATC PILOT</h4>
                    ...
                    <div class="col-md-3">
                        <figure>
                            <img src="http://exposure.mx/images/prox3.jpg" class="img-fluid">
                        </figure>
                        <h4>FOCUS</h4>
                    ...
                    <div class="col-md-3">
                        <figure>
                            <img src="http://exposure.mx/images/prox4.jpg" class="img-fluid">
                        </figure>
                        <h4>TRAILROC 285</h4>
