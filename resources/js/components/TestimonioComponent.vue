                    ...
                    <div class="row">
                        <div class="testimonio col-md-6">
                            <div class="testimonio-header">
                                <div class="testImg">
                                    <img src="http://exposure.mx/images/testimonios/test1.jpg" class="img-fluid">
                                </div>
                                <div class="datos">
                                    <span class="titulo">THE RUNNER</span>
                                    <span class="nombre">ISABEL BOLIVAR</span>
                                </div>
                            </div>
                        ...
                        <div class="testimonio col-md-6">
                            <div class="testimonio-header">
                                <div class="testImg">
                                    <img src="http://exposure.mx/images/testimonios/test1.jpg" class="img-responsive">
                                </div>
                                <div class="datos">
                                    <span class="titulo">THE RUNNER</span>
                                    <span class="nombre">ISABEL BOLIVAR</span>
