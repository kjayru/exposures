...
@if(@$item['subitem'] == [])
    ...
    <li >
        <p>{{ $item['name'] }}</p>
        <a href="{{ route('marca.edit',['id'=>$item['id']]) }}" class="btn btn-xs btn-primary"><i class="fa fa-fw fa-pencil"></i></a>
        ...
        @foreach($item['subitem'] as $j => $submenu)
            ...
            @if (@$submenu['subitem'] == [])
                <li >
                   ...
                   <p>{{$submenu['name']}}</p>
                   <a href="{{ route('marca.edit',['id'=>$submenu['id']]) }}" class="btn btn-xs btn-primary"><i class="fa fa-fw fa-pencil"></i></a>
